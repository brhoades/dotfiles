{ pkgs, ... }:
{
  ...
  home.file."Library/LaunchAgents/com.koekeishiya.skhd.plist".source =
    ./launchagents/com.koekeishiya.skhd.plist;
  home.file."Library/LaunchAgents/com.koekeishiya.yabai.plist".source =
    ./launchagents/com.koekeishiya.yabai.plist;
}
