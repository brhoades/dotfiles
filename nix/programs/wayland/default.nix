      ...
      config = {
        ...
        keybindings =
          ...
          in
          {
            ...
            "XF86Launch8" = ''exec --no-startup-id pactl set-source-volume "@DEFAULT_SOURCE@" "+2%"'';
            "XF86Launch9" = ''exec --no-startup-id pactl set-source-volume "@DEFAULT_SOURCE@" "-2%"'';
            "XF86Launch7" = ''exec --no-startup-id pactl set-source-mute "@DEFAULT_SOURCE@" toggle'';
